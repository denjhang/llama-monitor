...
E:\working\llama-cpp\llama-b11139\llama-server.exe -m "%MODEL%" --mmproj "%MMPROJ%" --model-draft "%DRAFT%" --spec-type draft-dflash --spec-draft-n-max 4 -ngl 99 -ngld 99 -c 262144 -ctk q4_0 -ctv q4_0 -fa on -np 1 --jinja --host 127.0.0.1 --port 8080 >> llama-server.log 2>&1
